...
class LookupAccountCreatedApplications extends jsonrequest_js_1.default {
    /**
    ...
    prepare(response) {
        return (0, encoding_js_1.decodeJSON)(response.getJSONText(), types_js_1.ApplicationsResponse);
    }
}
