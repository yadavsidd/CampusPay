 ...
 * Executes compile
 */
class Compile extends jsonrequest_js_1.default {
    ...
    executeRequest(headers, customOptions) {
        ...
        return this.c.post({
            ...
            data: (0, binarydata_js_1.coerceToBytes)(this.source),
            query: this.query,
    ...
    // eslint-disable-next-line class-methods-use-this
    prepare(response) {
        return (0, encoding_js_1.decodeJSON)(response.getJSONText(), types_js_1.CompileResponse);
    }
}
