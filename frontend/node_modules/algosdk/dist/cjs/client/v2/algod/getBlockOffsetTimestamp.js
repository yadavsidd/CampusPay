...
class GetBlockOffsetTimestamp extends jsonrequest_js_1.default {
    ...
    // eslint-disable-next-line class-methods-use-this
    prepare(response) {
        return (0, encoding_js_1.decodeJSON)(response.getJSONText(), types_js_1.GetBlockTimeStampOffsetResponse);
    }
}
